...
import com.cooxiao.mall.pojo.valid.product.AlbumRegExpression;
...
@Data
public class AlbumUpdateDTO implements AlbumRegExpression, Serializable {

    /**
     * 验证请求参数失败的描述文本前缀
     */
    private static final String VALIDATE_MESSAGE_PREFIX = "修改相册失败，";
     ...
     * 相册简介
     */
    @ApiModelProperty(value = "商品相册简介", required = true)
