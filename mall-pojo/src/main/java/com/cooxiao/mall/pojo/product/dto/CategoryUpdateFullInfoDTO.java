...
import com.cooxiao.mall.pojo.valid.product.CategoryRegExpression;
...
@Data
public class CategoryUpdateFullInfoDTO implements CategoryRegExpression, Serializable {

    /**
     * 验证请求参数失败的描述文本前缀
     */
    private static final String VALIDATE_MESSAGE_PREFIX = "修改类别完整信息失败，";
