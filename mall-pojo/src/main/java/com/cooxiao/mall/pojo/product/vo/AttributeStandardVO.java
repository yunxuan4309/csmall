package com.cooxiao.mall.pojo.product.vo;
...
public class AttributeStandardVO implements Serializable {
     ...
     * 所属属性模板id
     */
    @ApiModelProperty(value = "属性关联到的模板的id", position = 3)
    private Long templateId;

    /**
     * 简介（某些属性名称可能相同，通过简介补充描述）
     */
    @ApiModelProperty(value = "属性简介", position = 4)
    private String description;

    /**
     * 属性类型，1=销售属性，0=非销售属性
     */
    @ApiModelProperty(value = "属性类型，1=销售属性，0=非销售属性", position = 5)
    private Integer type;

    /**
     * 输入类型，0=手动录入，1=单选，2=多选， 3=单选（下拉列表），4=多选（下拉列表）
     */
    @ApiModelProperty(value = "属性输入类型，0=手动录入，1=单选，2=多选， 3=单选（下拉列表），4=多选（下拉列表）", position = 6)
    private Integer inputType;

    /**
     * 备选值列表
     */
    @ApiModelProperty(value = "属性备选值列表", position = 7)
