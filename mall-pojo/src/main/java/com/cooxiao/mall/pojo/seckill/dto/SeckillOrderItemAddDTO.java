...
import com.cooxiao.mall.pojo.valid.seckill.SeckillOrderItemRegExpression;
...
@ApiModel(value="秒杀订单商品新增DTO")
@Data
public class SeckillOrderItemAddDTO implements SeckillOrderItemRegExpression,Serializable {
