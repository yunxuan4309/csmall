...
import com.cooxiao.mall.pojo.valid.product.BrandRegExpression;
...
@Data
public class BrandUpdateDTO implements BrandRegExpression, Serializable {

    /**
     * 验证请求参数失败的描述文本前缀
     */
    private static final String VALIDATE_MESSAGE_PREFIX = "修改品牌失败，";
    ...
    @NotNull(message = VALIDATE_MESSAGE_PREFIX + "请填写Logo的URL！")
