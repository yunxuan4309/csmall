...
# 5. 一键重启所有微服务
systemctl restart mall-gateway mall-sso mall-product mall-front mall-search mall-order mall-seckill mall-ums mall-ams mall-resource

# 6. 查看所有服务状态
systemctl status mall-gateway mall-sso mall-product mall-front mall-search mall-order mall-seckill mall-ums mall-ams mall-resource
