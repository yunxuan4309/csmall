...
> **关联（仅互链、不合并）**: [[AI导购Agent实现详解]]（📦 已归档：实现说明书）· [[AI导购Agent升级方案]]（计划与清单）· [[问题解决--LLM链路的契约漂移与分层降级]]（同批的另一半：契约与降级）· [[TODO已完成]] §十六/§十七 · [[问题解决--SpringBoot2升级3]]（真要升级时的迁移记录）
...
- **计划与清单**：[[AI导购Agent升级方案]] · [[TODO已完成]] §十六 / §十七
