...
> **创建日期**: 2026-05-13
> **最后更新**: 2026-09-03（新增 #38~#41：Dockerfile 双份不一致、镜像仓库+CI/CD+healthcheck、日志聚合；源自容器化部署企业级差距评估。此前 2026-08-28 已记 #6/#16~#30：Dubbo 应用名撞名、TraceId 日志规范、认证安全升级、购物车 Redis 演进、订单价格库存校验、死权限码清理、BFF 补强、CORS 收敛、校验漏触发接口、MySQL 密码+端口绑定、JWT_SECRET 随机化、网络隔离、KMS 认知、JRE 无诊断工具、数据库备份、Prometheus 告警）
