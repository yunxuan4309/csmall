...
| 2 | 老机端口放行：2a MySQL 3306 / Redis 6379 改绑 `172.29.193.239`；2b product/order Dubbo 端口发布 + 注册宿主 IP | **维护窗口** | 🟡 中 | 🟢 **改动已备好并入库（compose md5 `b8f9d58e`，已 pre-stage 到两台 /tmp），待维护窗口** |
