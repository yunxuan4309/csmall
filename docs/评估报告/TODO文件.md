...
> **做"定期交叉核对"时请排除 `*-副本.md`**，否则会误判数量（本表口径 = **17 = 🟡8 + 🟢2 + ✅2 + ⚪5**；2026-09-11 一天内三次复核：先修正 19/7 → 20/8 → 同日**首次归档 1 篇**（《集群化与配置中心迁移方案》）+ **新建 1 篇**（《配置中心迁移方案》）→ 20 → **同日第二次归档 3 篇**（《AI导购Agent实现详解》《AI模型名停用风险与thinking参数改造方案》《本地双实例锁验证报告-2026-09-09》）→ **17**）。
...
> **计数**：`docs/问题解决/` 由 **36 → 41** 篇（A2 的 8 篇 + A2b 的 5 篇 + 早期 28 篇）。
