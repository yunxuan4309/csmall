...
> ⚠️ **推荐顺序（2026-09-12 决策 · 历史记录）：#65 ✅ → #54 ✅ → #31 ✅（已于 09-12 晚开启） → #61 ✅ → 录像**（**#55 已于 2026-09-12 收口为"已评估·接受"，无需动作**）。
...
| `pms_sku_specification`（规格值：属性名-值） | **2 行**（仅"存储容量"） | **2026-09-12 实测 36** 个 SKU 中仅 2 个有（现为 **38** 个） |
