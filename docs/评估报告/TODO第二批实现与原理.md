...
**本批新增的相关文档**：~~[[AI模型名停用风险与thinking参数改造方案]]~~（TODO **#58**，由 #33 的"模型分工"踩坑延伸而来 ⇒ ✅ **2026-09-10 已完成并部署**；该方案文档已于 2026-09-11 移入 `docs/归档/`）
...
> ⚠️ **本表曾长期与 §六/§七·六/§七·七 自相矛盾**（表里已标 ✅，§六 却还写"待实施"）——根因是 §七·五/七·六/七·七 为 09-08 当晚**追加**章节，未回头同步前文。**2026-09-10 已统一**。（⚠️ 2026-09-12：此处原有一段**完全重复**的同样警告，已删除）
...
| 编号 | 事项 | 方案文档 | 关键难点 | 状态 |
|---|---|---|---|---|
| **#13** | Nacos 认证 | [[集群化与配置中心迁移方案]] §A0 | 11 服务+Seata+Dubbo 全配账号，原子切换 | ✅ **已完成 + 已部署**（2026-09-08；原 §七·七 已迁出 ⇒ 见 [[问题解决--生产安全加固与凭据治理]] §四）|
