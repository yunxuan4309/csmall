...
> **原理与 8 处踩坑的完整过程** → [[TODO第三批实现与原理-1]] **§十三**；**方案正文与实测记录** → [[Python模拟数据与AI并发测试方案]]（§〇.1 复核 / §2.2.9 标识设计 / §5.1 压测实测 / §6 可观测 SOP / §6.4.1 录像 Runbook）。
...
- **方案正文**：[[Python模拟数据与AI并发测试方案]]（§〇.1 复核 9 条 · §2.2.9 标识设计 · §5.1 压测实测 · §6 可观测 SOP · **§6.4.1 录像 Runbook**）
